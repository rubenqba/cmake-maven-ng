...
public class GenerateMojo extends AbstractMojo {
	...
	/**
	 * Location of the source files. This should be where the sources are
	 * checked in.
	 * 
	 ...
	 * 
	 * Note that it is usually better to use a CMake variable than an
	 * environment variable. To quote the CMake FAQ:
	 * 
